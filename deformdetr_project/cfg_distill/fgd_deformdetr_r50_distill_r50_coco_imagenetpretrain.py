...
distiller = dict(
    ...
    teacher_pretrained = '/nfs/chenzehui/data/pretrain_models/deformable_detr_r50_16x2_50e_coco_20210419_220030-a12b9512.pth',
    init_student = False,
    distill_cfg = [ dict(student_module = 'neck.extra_convs.0.conv',
...
student_cfg = '/nfs/chenzehui/code/knowledge_distill/configs/deformable_detr/deformable_detr_r50_16x2_50e_coco.py'
teacher_cfg = '/nfs/chenzehui/code/knowledge_distill/configs/deformable_detr/deformable_detr_r50_16x2_50e_coco.py'
optimizer = dict(
    _delete_=True,
    type='AdamW',
    lr=2e-4,

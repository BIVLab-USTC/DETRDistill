...
class QueryCrossDetectionDistiller(BaseDetector):
    ...
    def __init__(self,
        ...
        super(QueryCrossDetectionDistiller, self).__init__()
    ...
    def forward_train(self, img, img_metas, **kwargs):
        ...
        with torch.no_grad():
            self.teacher.eval()
            teacher_query = self.teacher.bbox_head.query_embedding.weight
           
        student_loss = self.student.forward_train_querycross(img, img_metas, teacher_query=teacher_query, **kwargs)
